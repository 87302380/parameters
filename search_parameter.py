...
def get_parameters(data, target_feature_index):
	...
	if args.worker:
		...
		w = worker(data, target_feature_index, sleep_interval = 0.5,run_id=args.run_id, host=host)
	...
	w = worker(data, target_feature_index, sleep_interval = 0.5,run_id=args.run_id, host=host, nameserver=ns_host, nameserver_port=ns_port)
